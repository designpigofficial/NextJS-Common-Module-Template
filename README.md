...
Now, whenever I need an element to act like a container (which should switch **automatically** from dark to light mode *(and viceversa)*), I can just add the `theme-apply-bg-sec="true"` and the code under the hood will do the heavy work.
